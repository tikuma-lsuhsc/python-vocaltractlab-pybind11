...
namespace vocaltractlab
{
    ...
    void initGeometry(py::module &m)
    {
        py::class_<Point2D>(m, "Point2D")
            ...
            .def("__ne__", py::overload_cast<const Point2D &, const Point2D &>(operator!=))
            .def("__eq__", py::overload_cast<const Point2D &, const Point2D &>(operator==))
            .def("__add__", py::overload_cast<const Point2D &, const Point2D &>(operator+))
            .def("__sub__", py::overload_cast<const Point2D &, const Point2D &>(operator-))
            .def("__mul__", py::overload_cast<const Point2D &, double>(operator*))
            .def("__rmul__", py::overload_cast<double, const Point2D &>(operator*))
            .def("__truediv__", py::overload_cast<const Point2D &, double>(operator/))
            .def("__neg__", py::overload_cast<const Point2D &>(operator-))
            .def("scalar_product", py::overload_cast<const Point2D &, const Point2D &>(scalarProduct), "q"_a)
            .def("__matmul__", py::overload_cast<const Point2D &, const Point2D &>(scalarProduct), "q"_a);
        ...
        py::class_<Point3D>(m, "Point3D")
            ...
            .def("__ne__", py::overload_cast<const Point3D &, const Point3D &>(operator!=))
            .def("__eq__", py::overload_cast<const Point3D &, const Point3D &>(operator==))
            .def("__add__", py::overload_cast<const Point3D &, const Point3D &>(operator+))
            .def("__sub__", py::overload_cast<const Point3D &, const Point3D &>(operator-))
            .def("__mul__", py::overload_cast<const Point3D &, double>(operator*))
            .def("__rmul__", py::overload_cast<double, const Point3D &>(operator*))
            .def("__truediv__", py::overload_cast<const Point3D &, double>(operator/))
            .def("__neg__", py::overload_cast<const Point3D &>(operator-))
            .def("scalar_product", py::overload_cast<const Point3D &, const Point3D &>(scalarProduct), "q"_a)
            .def("__matmul__", py::overload_cast<const Point3D &, const Point3D &>(scalarProduct))
            .def("cross_product", py::overload_cast<const Point3D &, const Point3D &>(crossProduct), "q"_a);
        ...
        py::class_<Vector2D>(m, "Vector2D")
            ...
            .def("get_interaction", [](Vector2D &self, Vector2D &V)
                 { 
                    double t; 
                    auto p = self.getIntersection(V,t); 
                    return py::make_tuple(p,t); }, "v"_a)
            .def("get_interaction", [](Vector2D &self, Line2D &L)
                 { 
                double t; 
                bool ok; 
                Point2D p = self.getIntersection(L,t,ok); 
                return py::make_tuple(p, t, ok); }, "line"_a)
            .def("get_interaction", [](Vector2D &self, Line3D &L)
                 { 
                double t; 
                bool ok; 
    	...
    	py::class_<Line2D>(m, "Line2D")
            ...
            .def("get_interaction", [](Line2D &self, Vector2D &V)
                 { 
                double t; 
                bool ok; 
                Point2D p = self.getIntersection(V,t,ok); 
                return py::make_tuple(p, t, ok); }, "vector"_a)
            .def("get_interaction", [](Line2D &self, Line2D &L)
                 { 
                double t; 
                bool ok; 
                Point2D p = self.getIntersection(L,t,ok); 
        ...
        py::class_<Line3D>(m, "Line3D")
            ...
            .def("get_interaction", [](Line3D &self, Vector2D &V)
                 { 
                double t; 
                bool ok; 
        ...
        py::class_<Circle>(m, "Circle")
            ...
            .def("get_length", py::overload_cast<double, double>(&Circle::getLength), "a0"_a, "a1"_a)
            .def("get_point", &Circle::getPoint, "angle"_a)
            .def("get_normal", &Circle::getNormal, "angle"_a)
            .def("get_interaction", [](Circle &self, Vector2D &V)
                 { 
                double intersectionAngle;
                bool ok;
                Point2D p = self.getIntersection(V,intersectionAngle,ok); 
                return py::make_tuple(p, intersectionAngle, ok); }, "vector"_a)
            .def("get_interaction", [](Circle &self, Line2D &L)
                 { 
                double intersectionAngle;
                bool ok;
                Point2D p = self.getIntersection(L,intersectionAngle,ok); 
                return py::make_tuple(p, intersectionAngle, ok); }, "line"_a)
            .def("get_tangent_contact_angle", &Circle::getTangentContactAngle, "h"_a, "clockwise"_a)
            .def("get_bend", &Circle::getBend)
            .def("is_including", py::overload_cast<Point2D>(&Circle::isIncluding), "point"_a)
            .def("is_including", py::overload_cast<Line2D>(&Circle::isIncluding), "line"_a)
            .def("has_intersection_width", &Circle::hasIntersectionWith, "line"_a)
            .def("get_common_left_tangent_with", &Circle::getCommonLeftTangentWith, "circle"_a)
        ...
        py::class_<Ellipse2D>(m, "Ellipse2D")
            .def(py::init<>())
            .def(py::init<Point2D, double, double>(), "m"_a, "half_width"_a, "half_height"_a)
        ...
        m.def("get_ellipse_tangent", &getEllipseTangent, "point"_a, "center"_a, "a"_a, "b"_a, "clockwise"_a = false);
    }
}
