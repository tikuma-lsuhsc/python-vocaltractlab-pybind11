...
void initSurface(py::module &m) {
	...
	surface.def_readonly_static("NUM_ASSOCIATED", &Surface::NUM_ASSOCIATED_TRIANGLES)
	        ...
	        .def_readonly_static("STANDARD_CREASE_ANGLE_DEGREE",
	                             &Surface::STANDARD_CREASE_ANGLE_DEGREE)
	        ...
	        .def_property_readonly(
	                "tile",
	                [](Surface &self) { return std::span(std::span(self.tile)); },
	        ...
	        .def("setVertex",
	             py::overload_cast<int, int, double, double, double>(
	                     &Surface::setVertex),
	             "ribs"_a, "rib_points"_a, "x"_a, "y"_a, "z"_a)

	        /// Set the coordinates of the given vertex.
	        .def("setVertex",
	             py::overload_cast<int, int, const Point3D &>(&Surface::setVertex),
	             "ribs"_a, "rib_points"_a, "p"_a)

	        /// Get the coordinates of the given vertex.
	        .def(
	                "getVertex",
	                [](Surface &self, int rib, int ribPoint) {
		                double x, y, z;
		                self.getVertex(rib, ribPoint, x, y, z);
		                return py::make_tuple(x, y, z);
	                },
	                "ribs"_a, "rib_points"_a)
	...
	py::class_<Surface::Vertex>(surface, "Vertex")
	        ...
	        .def_property_readonly("associated_triangle",
	                               as_numpy_array(Surface::Vertex, associatedTriangle,
	                                              Surface::NUM_ASSOCIATED_TRIANGLES),
	                               py::return_value_policy::reference_internal)
	        .def_property_readonly("associated_corner",
	                               as_numpy_array(Surface::Vertex, associatedCorner,
	                                              Surface::NUM_ASSOCIATED_TRIANGLES),
	                               py::return_value_policy::reference_internal)
	...
	py::class_<Surface::Triangle>(surface, "Triangle")
	        .def_property_readonly("vertex",
	                               as_numpy_array(Surface::Triangle, vertex, 3),
	                               py::return_value_policy::reference_internal)
	        .def_property_readonly("edge", as_numpy_array(Surface::Triangle, edge, 3),
	                               py::return_value_policy::reference_internal)
	        .def_property_readonly(
	                "corner_normal",
	                as_std_span(Surface::Triangle, Point3D, cornerNormal),
	                py::return_value_policy::reference_internal)
	...
	py::class_<Surface::Edge>(surface, "Edge")
	        .def_property_readonly("vertex", as_numpy_array(Surface::Edge, vertex, 2),
	                               py::return_value_policy::reference_internal)
	...
	py::class_<Surface::Tile>(surface, "Tile")
	        ...
	        .def_property_readonly(
	                "triangle",
	                as_numpy_array(Surface::Tile, triangle, Surface::MAX_TILE_TRIANGLES),
	                py::return_value_policy::reference_internal);
}
}; // namespace vocaltractlab
